...
import { FSRS, createEmptyCard, generatorParameters, Rating, Card as FSRSCard, State, ReviewLog } from 'ts-fsrs';

export function calculateNextReview(card: Card, quality: number, settings: UserSettings): { updatedCard: Card, log: ReviewLog } {
